...
<section class="breadcrumbs">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <!-- <li class="breadcrumb-item active" aria-current="page">{!! trans('frontend.cart') !!}</li> -->
  ...
  <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-12 col-centered clearfix">
      
      <!-- <h2 class="cart-shopping-label">{{ trans('frontend.shopping_cart') }}</h2> -->
      <h2 class="cart-shopping-label">Shopping Cart Summary</h2>
