          ...
          <table class="table table-condensed">
            ...
            <tbody> 
              ...
              <tr class="order-items-data">
                <td colspan="2">
                    <div class="items-div-main"><div class="items-label">
                      @if($order_details_for_thank_you_page['cart_discount_manage']==1)
                      <strong>You Have Got Cart Total &nbsp;{{ $order_details_for_thank_you_page['cart_discount'] }} %</strong></div>
                      @endif
                </td>
                <td colspan="2" class="order-total">
                  ...
                  <div class="items-div-main"><div class="items-label"><strong>{{$order_details_for_thank_you_page['_order_shipping_method']}}</strong></div> <div class="items-value">{!! price_html( $order_details_for_thank_you_page['_final_order_shipping_cost'], $order_details_for_thank_you_page['_order_currency'] ) !!}</div></div>
