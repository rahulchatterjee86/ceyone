...
@section('content')
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-centered">
            <div class="checkout-content">
              ...
              <div class="">
                <div id="cart_summary" class="step well custom-cart-summary">
                    ...
                    <ul class="cart-data">
                      ...
                      @foreach(Cart::items() as $index => $items)
                        ...
                        <li class="row items-inline">
                          <div class="itemName">
                            ...
                            <div class="item-name">
                              ...
                              @endif
                               ...
                               @if(!empty($items->added_type) && $items->added_type == 'offer')
                               <br>
                                <span style="color: green;font-style: italic;font-weight: bold;">Offer Product</span>
                               @endif
                          ...
                          <div class="quantity"><input type="number" class="form-control cart_quantity_input" name="cart_quantity[{{ $index }}]" value="{{ $items->quantity }}" min="1" @if(!empty($items->added_type) && $items->added_type == 'offer') {{ 'readonly' }} @endif ></div>
                          ...
                          <div class="popbtn">
                          <a class="cart_quantity_delete delete-extra-padding" href="{{ route('removed-item-from-cart', $index)}}">
                          <!-- <i class="fa fa-close"></i> -->
                          <img src="storage/app/public/images/close.png"/>
                          </a>
                          </div>
                        </li>
                      @endforeach
                ...
                <div class="user-address-content">
                  <div class="address-information clearfix">
                    ...
                    <div class="address-content-sub">
                      ...
                      @if($local_pickup_enable==true)
                      <input type="checkbox" name="local_pickup" id="local_pickup" class="local-iCheck"> Local Pick Up
                      @endif
                      <br><br>
                      <div class="different">
                      <input type="checkbox" name="different_shipping_address" id="different_shipping_address" class="shopist-iCheck" value="different_address"> 
                      {{ trans('frontend.different_shipping_label') }}</div>
              ...
              <div id="authentication" class="step well">
                ...
                <div class="user-login-content">
                  ...
                  <div class="login-content-sub">
                      <h3>Already have an <br/><span>account?</span></h3>
                      ...
                      <div class="form_content">
                        ...
                        <a class="btn btn-secondary custom-button-login-signup" href="{{ route('user-login-page') }}">{!! trans('frontend.signin_account_label') !!}</a>
                      </div>
                    </div>
                    ...
                    <div class="login-content-sub">
                      <h3>New to <br/><span>Ceyone?</span></h3>
                      <!-- <h3 class="page-subheading">{!! trans('frontend.create_an_account_label') !!}</h3> -->
                      <div class="form_content">
                        <p>Register yourself with Ceyone</p>
                        <!-- <p>{!! trans('frontend.no_user_account_msg') !!}</p> -->
                        <a class="btn btn-secondary custom-button-login-signup" href="{{ route('user-registration-page') }}">{!! trans('frontend.create_account_label') !!}</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div id="login_user_address" class="step well">
                ...
                <div class="text-right">
                  @if(!empty($login_user_account_data) && !empty($login_user_account_data->address_details))
                    @if($local_pickup_enable==true)
                    <input type="checkbox" name="local_pickup" id="distributor_local_pickup" class="distributor-local-iCheck"> Local Pick Up
                    @endif
                  &nbsp;&nbsp;&nbsp;
                ...
                <div class="user-address-content ">
                  <div class="address-information clearfix">
                    ...
                    <div class="address-content-sub distributor_billing">
                      ...
                      <input type="hidden" class="form-control" placeholder="{{ trans('frontend.first_name') }}" name="account_bill_first_name" id="" value="{!! $login_user_account_data->address_details->account_bill_first_name !!}">
                      <input type="hidden" class="form-control" placeholder="{{ trans('frontend.last_name') }}" name="account_bill_last_name" id="" value="{!! $login_user_account_data->address_details->account_bill_last_name !!}">

                      <input type="hidden" class="form-control" placeholder="" name="account_bill_phone_number" id="" value="{!! $login_user_account_data->address_details->account_bill_phone_number !!}">
              ...
              <div id="payment" class="step well">
                ...
                @if($payment_method_data['payment_option']['enable_payment_method'] == 'yes' && ($payment_method_data['bacs']['enable_option'] == 'yes' || $payment_method_data['cod']['enable_option'] == 'yes' || $payment_method_data['paypal']['enable_option'] == 'yes' || $payment_method_data['stripe']['enable_option'] == 'yes'))
                  <div class="payment-options">
                   ...
                   <input type="hidden" name="razorpay_api_data" value="{{ $razorpay_api_data }}" id="razorpay_api_data">
                    <span>
                     <label>
                       @if(old('payment_option') == 'razorpay')
                        <input type="radio" checked name="payment_option" class="shopist-iCheck" value="razorpay"> {{ $payment_method_data['razorpay']['method_title'] }}
                       @else
                        <input type="radio" name="payment_option" class="shopist-iCheck" value="razorpay"> {{ $payment_method_data['razorpay']['method_title'] }}
                       @endif
                     </label>
                    </span>
                   @endif
                ...
                @endif
                @if($_settings_data['general_settings']['checkout_options']['enable_guest_user'] == true || ($_settings_data['general_settings']['checkout_options']['enable_login_user'] == true && $is_user_login == true) || ($_settings_data['general_settings']['checkout_options']['enable_guest_user'] == false && $_settings_data['general_settings']['checkout_options']['enable_login_user'] == false))
                <div class="local_pickup_cart_summary">
                  <div class="local_pickup_cart_summary">
                    <h2 class="step-title">{!! trans('frontend.shopping_cart_summary_label') !!}</h2><hr>
                    <div class="shopping-cart-summary-content">
                      <ul class="cart-data">
              ...
              <div id="order_notes" class="step well">
                ...
                @if(Session::get('shopist_frontend_user_role') != 'Vendor')
                  ...
                  <div class="referal_id" style="margin-top: 30px;">
                    <h2 class="step-title">Referal Id</h2><hr>
                    <div class="order-extra-notes">
                      <input type="text" class="form-control" placeholder="Enter Referal Id (Optional)" value="{!! old('referal_id') !!}" name="referal_id" />
                    </div>
                  </div>
                @elseif (Session::get('shopist_frontend_user_role') == 'Vendor')
                <input type="hidden" readonly class="form-control" placeholder="Enter Referal Id (Optional)" value="{{ Session::get('dis_unique_id') }}" name="referal_id" />
              ...
              <br>
              <div class="custom-checkout-panel">
  ...
  <script>
    ...
    $('#distributor_local_pickup').on('ifChecked', function (event){
      $('#distributor_local_pickup').attr('value', '1');
      $('.distributor_billing').hide();
      $('.different').hide();
      var pickup_val = $('#distributor_local_pickup').val();
      // parseFloat(yourString).toFixed(2)
      var cart_sub_total = parseFloat($('#cart_sub_total').val());
      var delivery_fee = parseFloat($('#delivery_fee').val());
      var cart_total_val = cart_sub_total+delivery_fee;
       cart_total_val = parseFloat((cart_total_val)).toFixed(2);
      
        $.ajax({
          type:'get',
          url:"{{ url('local/pickup') }}",
          data:{pickup_val:pickup_val},
        ...
        if(pickup==1){
          $(".local_pickup_cost").show();
          $(".normal_shipping_cost").hide();
          $(".granded_cart_total").text('Rs.'+ cart_total_val);
        }
    });

    $('#distributor_local_pickup').on('ifUnchecked', function (event) {
      $('.distributor_billing').show();
      $('#distributor_local_pickup').attr('value', '2');
      var pickup_val = $('#distributor_local_pickup').val();
    ...
    $('#local_pickup').on('ifChecked', function (event){
        $('#local_pickup').attr('value', '1');
        $('.different-shipping-address').hide();
        $('.different').hide();
        var pickup_val   = $('#local_pickup').val();
        var cart_sub_total = parseFloat($('#cart_sub_total').val());
        var delivery_fee = parseFloat($('#delivery_fee').val());
        var cart_total_val = cart_sub_total+delivery_fee;
        cart_total_val = parseFloat((cart_total_val)).toFixed(2);
      ...
      $('#local_pickup').on('ifUnchecked', function (event) {
        $('#local_pickup').attr('value', '2');
        $('.different').show();
        var pickup_val   = $('#local_pickup').val();
          $.ajax({
            type:'get',
