              ...
              <div class="tab-general tab-pane fade show active" id="tab_general">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <label>
                        <input type="checkbox" name="cart_total_manage" id="cart_total_manage" class="shopist-iCheck" value="1">
                        &nbsp;Manage Cart Total
                      </label>
                    </div>
                  </div>
                ...
                <div class="role-based-pricing-content">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <input type="number" placeholder="Cart Total Price" id="inputRegularPrice" name="cart_total_price" class="form-control" min="0" step="any" value="">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <input type="number" placeholder="Discount Price" id="inputSalePrice" name="discount_amount" class="form-control" min="0" step="any" value="">
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="box-body">
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-sm-5">
                      <input type="number" min="1" value="" name="bv_points" class="form-control"/>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="box-body">
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-sm-5">
                  <input type="number" min="1" value="" name="appliation_point" class="form-control"/>
              </div>
            </div>
          </div>
        </div>
