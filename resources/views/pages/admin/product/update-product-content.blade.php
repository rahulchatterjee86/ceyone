          ...
          <div class="tabbable tabs-left">
            ...
            <div class="tab-content">
              <div class="tab-general tab-pane fade {{ $tabSettings['generalTab'] }}" id="tab_general">
                ...
                <div class="form-group">
                  <div class="row">
                    <label class="col-sm-6 control-label" for="inputManageStock">Manage Cart Total</label>
                    <div class="col-sm-6">
                      <label>
                        <input type="checkbox" name="cart_total_manage" id="cart_total_manage" class="shopist-iCheck" value="1"  @if($pdetails['cart_total_manage']==1) checked @endif>
                        &nbsp;Manage Cart Total
                      </label>
                    </div>
                  </div>
                </div>
                <p style="font-size: 17px;font-weight:bold;color:#3c8dbc;"><i>Cart Total  Price</i></p><hr>
                  <div class="role-based-pricing-content">
                    <div class="form-group">
                      <div class="row">
                        <label class="col-sm-6 control-label" for="inputRegularPrice">Cart Total Amount ({!! $currency_symbol !!})</label>
                        <div class="col-sm-6">
                          <input type="number" placeholder="Cart Total Price" id="inputRegularPrice" name="cart_total_price" class="form-control" min="0" step="any" value="{{ $pdetails['cart_total'] }}">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                        <label class="col-sm-6 control-label" for="inputSalePrice">Discount Amount ({!! $currency_symbol !!})</label>
                        <div class="col-sm-6">
                          <input type="number" placeholder="Discount Price" id="inputSalePrice" name="discount_amount" class="form-control" min="0" step="any" value="{{ $pdetails['discount_amount'] }}">
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <div class="col-md-4">
      ...
      <div class="box box-solid visibility-product">
        <div class="box-header with-border">
          ...
          <h3 class="box-title">BV Points</h3>
        </div>
        <div class="box-body">
          <div class="form-group">
            <div class="row">
              <label class="col-sm-7 control-label" for="inputVisibility">BV Point Value</label>
              <div class="col-sm-5">
                      <input type="number" min="1" value="{{ $pdetails['bv_points'] }}" name="bv_points" class="form-control"/>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="box box-solid visibility-product">
        <div class="box-header with-border">
          <i class="fa fa-gift"></i>
          <h3 class="box-title">Affilliation Points</h3>
        </div>
        <div class="box-body">
          <div class="form-group">
            <div class="row">
              <label class="col-sm-7 control-label" for="inputVisibility">Affilliation Value</label>
              <div class="col-sm-5">
                  <input type="number" min="1" value="{{ $pdetails['appliation_point'] }}" name="appliation_point" class="form-control"/>
              </div>
            </div>
          </div>
        </div>
