            ...
            <div class="float-right">
              <ul class="right-menu top-right-menu">
                ...
                <li class="mini-cart-content no-pad-right">
                  @include('pages.ajax-pages.mini-cart-html-second')
                </li>
              </ul>
            </div> 
          </div>   
        ...
        <div class="float-right">
              <ul class="right-menu top-right-menu">
                ...
                <div class="new-dropdown-menu dropdown-content my-account-menu">
                    ...
                    @else
                    <a href="{{ route('user-login-page') }}">{!! trans('frontend.frontend_user_login') !!}</a>
                    <a href="{{ route('distributor-login-page') }}">Distributor Login</a>
                    @endif
                			...
                			<div class="row">
                				<div class="col">
                					<div class="cat-content">
                						<img src="<?php echo url("/public/uploads/healthcare-spirulina-nav.jpg");?>">
                					</div>
                					<div class="cat-content"><h5><a href="<?php echo url("/product/categories/health-care");?>">Health Care</a></h5><hr></div>
                				</div>
                				<div class="col">
                					<div class="cat-content"><img src="<?php echo url("/public/uploads/oralcare-cristaa-nav.jpg");?>"></div>
                					<div class="cat-content"><h5><a href="<?php echo url("/product/categories/oral-care");?>">Oral Care</a></h5><hr></div>
                				</div>
                			</div>
                			<div class="row">
                				<div class="col">
                					<div class="cat-content"><img src="<?php echo url("/public/uploads/agricare-cropgrow-nav.jpg");?>"></div>
                					<div class="cat-content"><h5><a href="<?php echo url("/product/categories/agri-care");?>">Agri Care</a></h5><hr></div>
                				</div>
                				<div class="col">
                					<div class="cat-content"><img src="<?php echo url("/public/uploads/personalcare-footcream-nav.jpg");?>"></div>
