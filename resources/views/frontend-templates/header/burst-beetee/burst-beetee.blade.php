    ...
    <header class="main-header">
      ...
      <div class="main-box">
          ...
          <div class="logo"><a href="index-2.html"><img src="{{ URL::asset('public/burst_beetee/images/logo.png') }}" alt=""></a></div>
                  ...
                  <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                      <ul class="navigation clearfix">
                          <li class="current dropdown"><a href="index-2.html">Home</a>
                              <ul>
                                  <li><a href="{{ url("/product/categories/health-care") }}">Sample</a></li>
                          ...
                          <li class="dropdown has-mega-menu"><a href="#">Shop</a>
                              <div class="mega-menu">
                                  <div class="mega-menu-bar row clearfix">
                                      ...
                                      <div class="image-box">
                                          <figure class="image"><img src="{{ URL::asset('public/burst_beetee/images/resource/mega-menu-shop.jpg') }}" alt=""></figure>
                                      </div>
                                  </div>
                              </div>
                          </li>
                          ...
                          <li class="dropdown has-mega-menu"><a href="#">Pages</a>
                              <div class="mega-menu">
                                  <div class="mega-menu-bar row clearfix">
                                      ...
                                      <div class="image-box">
                                          <figure class="image"><img src="{{ URL::asset('public/burst_beetee/images/resource/mega-menu-pages.jpg') }}" alt=""></figure>
                                      </div>
                                  </div>
                              </div>
                          </li>
      ...
      <div class="search-popup">
          ...
          <div class="search-inner">
              <form method="post" action="https://codexlayer.com/html/burst_beetee/search-error.html">
      ...
      <div class="sticky-header">
          <div class="auto-container clearfix">
              ...
              <div class="logo pull-left">
                  <a href="index-2.html" title=""><img src="{{ URL::asset('public/burst_beetee/images/logo-small.png') }}" alt="" title=""></a>
              </div>
              <!--Right Col-->
      ...
      <div class="sidebar-cart">
          ...
          <div class="shopping-cart">
              ...
              <ul class="shopping-cart-items">
                  <li class="cart-item">
                      <img src="{{ URL::asset('public/burst_beetee/images/resource/products/p-thumb-1.png') }}" alt="" class="thumb" />
                  ...
                  <li class="cart-item">
                      <img src="{{ URL::asset('public/burst_beetee/images/resource/products/p-thumb-2.png') }}" alt="" class="thumb"  />
                      <span class="item-name">Desodorante Para Mujer</span>
                  ...
                  <li class="cart-item">
                      <img src="{{ URL::asset('public/burst_beetee/images/resource/products/p-thumb-3.png') }}" alt="" class="thumb"  />
                      <span class="item-name">Desodorante Para Mujer</span>
  ...
  <div class="mobile-menu">
      ...
      <nav class="menu-box">
          <div class="mobile-upper">
              ...
              <div class="logo"><img src="{{ URL::asset('public/burst_beetee/images/logo-small.png') }}" alt=""></div>
          </div>
